...
public class Member_List  extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Member_List.this, Member_window.class);
                startActivity(i);
                finish();
                    ...
                    public void onResponse(String response) {
                       ...
                       if(!StackHolders.isEmpty()){
                        ...
                        if(!Members.isEmpty()){
                            ...
                            memberRv sAdapter = new memberRv(Member_List.this, Members);
                            sAdapter.notifyDataSetChanged();
                            MemberRv.setAdapter(sAdapter);
                            LinearLayoutManager mLayoutManager = new LinearLayoutManager(Member_List.this);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        if(keyCode== KeyEvent.KEYCODE_BACK)   {
            if(!Member_List.this.isFinishing()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Member_List.this, R.style.AlertDialogTheme)
