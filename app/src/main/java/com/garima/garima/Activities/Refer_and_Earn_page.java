...
public class Refer_and_Earn_page extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strShareMessage = "\nI have a coupon worth \u20B9" + String.valueOf(pref.getUser_refernce_code_coupon_Amt()) + " for you. Sign up with my code " + pref.getReferalCode() +
                " to avail disount!" + "https://play.google.com/store/apps/details?id=" + getPackageName();
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Refer_and_Earn_page.this, Mainactivity.class);
                startActivity(i);
                finish();
    ...
    private void onInviteClicked() {
        Intent intent = new AppInviteInvitation.IntentBuilder("Send mail or SMS")
                .setMessage("Lets join Garima and start earning.")
                .setDeepLink(Uri.parse("garima://use/" + "=" + _PhoneNo + ":" + Refer_code))
                .setCustomImage(Uri.parse("http://139.59.38.160/Garima/Dashboard/ic_launcher.png"))
    ...
    public void sendEmail(String s) {
        ...
        i.putExtra(Intent.EXTRA_EMAIL, new String[]{"info@garimatrading.com"});
